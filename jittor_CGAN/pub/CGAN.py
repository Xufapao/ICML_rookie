...
for epoch in range(opt.n_epochs):
    ...
    if epoch % 10 == 0:
        g_pth = "../g_pth/generator_"+epoch/10+"_.pkl"
        d_pth = "../d_pth/generator_"+epoch/10+"_.pkl"
        generator.save(g_pth)
        discriminator.save(d_pth)
        
        generator.save("generator_last_.pkl")
...
number = "28144122807204"#TODO: 写入比赛页面中指定的数字序列（字符串类型）
n_row = len(number)
