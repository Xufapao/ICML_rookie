...
def sample_image(n_row, batches_done):
    ...
    labels = Variable(LongTensor(np.array([num for _ in range(n_row) for num in range(n_row)])))
...
number = "123123123"  # TODO: Write the specified number sequence from the competition page
n_row = len(number)
